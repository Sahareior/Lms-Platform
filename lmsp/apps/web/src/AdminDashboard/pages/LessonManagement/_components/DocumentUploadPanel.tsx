import { Loader2, Sparkles, Upload, Database } from 'lucide-react';
...
export default function DocumentUploadPanel({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Knowledge Base Document Management Card ── */}
      <SectionCard
        icon={<Database size={18} className="text-white" />}
        title="Uploaded Knowledge Base Documents"
        subtitle="View, preview, and manage indexed RAG documents and vector embeddings"
        accentColor="emerald"
      >
        <RagDocumentList onShowToast={onShowToast} />
      </SectionCard>
    </div>
  );
}
