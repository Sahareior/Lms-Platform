    ...
    return (
      ...
      >
        ...
        {isLoading ? (
          ...
          <>
            <div className="flex-1 space-y-2 min-h-0 relative z-10">
              {leaderboard.slice(0, 6).map((entry) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Avatar */}
                    <div className={`w-7 h-7 rounded-full border flex items-center justify-center shrink-0 overflow-hidden ${
