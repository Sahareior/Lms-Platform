...
export default function PerfHeader({
  ...
  if (!isDark) {
    return (
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-[#f2efe9] border border-[#d8d4cb] p-4 rounded-2xl shadow-[2px_2px_0px_0px_#1a1a1a]">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-full bg-[#b91c1c]/10 border border-[#b91c1c]/30 text-[#b91c1c] flex items-center justify-center font-bold text-lg">
            AI
          </div>
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-lg font-bold text-[#1a1a1a] font-serif">
            ...
            <p className="text-xs text-[#4a4a4a] font-serif italic">{subtitle}</p>
            {generatedAt && !isLoading && (
              <p className="text-[10px] text-[#4a4a4a] flex items-center gap-1 mt-0.5">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          <button
            ...
            className="flex items-center justify-center gap-1 text-xs bg-[#1a1a1a] text-[#f2efe9] font-semibold px-3 py-1.5 rounded-lg hover:translate-x-[1px] hover:translate-y-[1px] transition w-full md:w-auto active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-1 text-xs border border-[#d8d4cb] px-3 py-1.5 rounded-lg hover:bg-[#e8e4db] text-[#1a1a1a] bg-[#f8f5f1] w-full md:w-auto transition active:scale-95"
          >
            <Calendar size={14} /> Saved reports
            {reportCount > 0 && (
              <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-[#b91c1c]/10 text-[#b91c1c] font-bold">
                {reportCount}
              </span>
            )}
            <ChevronDown size={12} />
